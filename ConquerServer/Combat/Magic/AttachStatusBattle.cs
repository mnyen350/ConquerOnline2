...
namespace ConquerServer.Combat
{
    ...
    {
        public AttachStatusBattle(Entity source, Entity? target, int castX, int castY, MagicTypeModel spell)
        ...
        protected override PotentialTargetError IsPotentialTarget(Entity target)
        {
