...
namespace ConquerServer
{
    ...
    public class Item
    {
        ...
        public ItemSort Sort { get { return GetSort(this.TypeId); } }
        public ItemType SubType {  get { return GetSubType(this.TypeId); } }
        public ItemPosition EquipPosition {  get { return GetItemPosition(this.Sort, this.SubType); } }
        ...
        { 
            get
            {
                if (_attributes == null || _attributes.TypeId != this.TypeId)
                {
                    _attributes = Db.GetItemTypeByTypeId(this.TypeId);
                }
                return _attributes;
            } 
        }
